<nav class="border-[#1E1E2C] border-2 w-full py-[18px] ">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-between">
        <a class="text-white font-bold items-center flex gap-2" href="http://localhost/plataforma_freelancer/public/">
        ...
        <ul class="text-[#C3C3D1] flex items-center gap-4 text-[16px]">
            ...
            <li class="hover:underline cursor-pointer"><a href="http://localhost/plataforma_freelancer/public/">Procurar
                    um projeto</a></li>
